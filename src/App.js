...
import imageGallery from './images/Screenshot_20230511-120205_Samsung Internet.jpg'
      ...
      <div class="col-md-6 col-sm-12">
        <div class="about-wrapper__info load-hidden">
          <h2 class="about-wrapper__info-text">
            <h1>my skills is: html, css, tailwind, bootstrap, js, react, next</h1><br />
  ...
  <div class="container">
    <div class="project-wrapper">
      ...
      <div class="row">
        <div class="col-lg-4 col-sm-12">
          <div class="project-wrapper__text load-hidden">
            <h2 class="project-wrapper__text-title">Image Gallery</h2>
            <div>
              <p class="mb-4">
                <h3>project overview:</h3><br />
                <ul>
                  <li>
                  1. Component-based architecture                  </li>
                  <li>
                  ...
                  <li>
                  4. Dynamic image loading and display
                  </li>
                  <li>
                  5. Integration with third-party libraries for advanced functionality (e.g. lightbox)
                  </li>
                </ul>
              </p>
            </div>
            <a
              ...
              target="_blank"
              class="cta-btn cta-btn--hero"
              href="https://fervent-aryabhata-0daf04.netlify.app/"
            >
              See Live
            </a>
            <a
              ...
              target="_blank"
              class="cta-btn text-color-main"
              href="https://github.com/jacksonhenderson/image-gallery-api"
            >
              Source Code
            </a>
          </div>
        ...
        <div class="col-lg-8 col-sm-12">
          <div class="project-wrapper__image load-hidden">
            <a rel="noreferrer" href="https://fervent-aryabhata-0daf04.netlify.app/" target="_blank">
              <div
                data-tilt
                data-tilt-max="4"
                data-tilt-glare="true"
